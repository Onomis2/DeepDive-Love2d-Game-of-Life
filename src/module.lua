...
function module.helpMenu()
    ...
    love.graphics.print("HELP MENU", width - 165, height - 390)
    love.graphics.setColor(1, 1, 1)
    -- Tip
    love.graphics.print("TIP: Hold Mouse 1 to place", width - 165, height - 380)
    love.graphics.print("and Mouse 2 to remove", width - 165, height - 360)
    -- Movement
    love.graphics.print("WASD: Move camera pos", width - 165, height - 320)
    love.graphics.print("Ctrl + WASD: Move slower", width - 165, height - 300)
    love.graphics.print("Shift + WASD: Move faster", width - 165, height - 280)
    love.graphics.print("SCROLL: Zoom cam in/out", width - 165, height - 260)
    love.graphics.print("R: Reset camera pos", width - 165, height - 240)
    -- Actions
    love.graphics.print("M1: Place cells", width - 165, height - 220)
    love.graphics.print("M2: Delete cells", width - 165, height - 200)
    love.graphics.print("P: Pause when placing", width - 165, height - 180)
    love.graphics.print("SPACE: Start/Pause", width - 165, height - 160)
    love.graphics.print("Arrow up/down: Control speed", width - 165, height - 140)
    -- Misc
