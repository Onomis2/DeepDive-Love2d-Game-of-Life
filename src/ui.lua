...
function ui.draw(brush)
    ...
    if UI == false then
        ...
        love.graphics.draw(block, 15, 50, 0, 0.3, 0.3)
        love.graphics.print("1", width - 1450, 90, 0, 1.4, 1.4)
        love.graphics.draw(glider, 115, 42, 0, 0.4, 0.4)
        love.graphics.print("2", width - 1375, 90, 0, 1.4, 1.4)
        love.graphics.draw(gliderGun, 225, 40, 0, 0.27, 0.27)
        love.graphics.print("3", width - 1090, 90, 0, 1.4, 1.4)
        love.graphics.draw(flyingShip, 500, 25, 0, 0.23, 0.23)
        love.graphics.print("4", width - 910, 90, 0, 1.4, 1.4)
        love.graphics.draw(pulsar, 650, 25, 0, 0.23, 0.23)
        love.graphics.print("5", width - 800, 90, 0, 1.4, 1.4)
        love.graphics.draw(heavyShip, 750, 50, 0, 0.3, 0.3)
        love.graphics.print("6", width - 725, 90, 0, 1.4, 1.4)
        love.graphics.draw(pulsatingGlider, 830, 25, 0, 0.23, 0.23)
        love.graphics.print("7", width - 660, 90, 0, 1.4, 1.4)
        love.graphics.draw(spaceship, 910, 15, 0, 0.23, 0.23)
        love.graphics.print("8", width - 525, 90, 0, 1.4, 1.4)
        love.graphics.draw(wheelOfFire, 1030, 20, 0, 0.23, 0.23)
        love.graphics.print("9", width - 435, 90, 0, 1.4, 1.4)
        love.graphics.print("/\\", 1160, 25, 0, 1.4, 1.4)
        love.graphics.print(tostring(deathCondition), 1160 , 55, 0, 1.4, 1.4)
        love.graphics.print("\\/", 1160, 80, 0, 1.4, 1.4)
        love.graphics.print("/\\", 1210, 25, 0, 1.4, 1.4)
        love.graphics.print(tostring(liveLower), 1210, 55, 0, 1.4, 1.4)
        love.graphics.print("\\/", 1210, 80, 0, 1.4, 1.4)
        love.graphics.print("/\\", 1260, 25, 0, 1.4, 1.4)
        love.graphics.print(tostring(liveUpper), 1260, 55, 0, 1.4, 1.4)
        love.graphics.print("\\/", 1260, 80, 0, 1.4, 1.4)
    end
